...
document.addEventListener("DOMContentLoaded", () => {
  ...
  savedContainer.innerHTML = ""; // clear
      ...
      <div class="card-media">
        ...
        <div class="card-info">
          ...
          <div class="icons">
            ...
            <!-- Save SVG (always active in saved page) -->
            <svg class="icon save active" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
